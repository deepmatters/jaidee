...
function convProcess(reqInput) {
    ...
    if (reqInput == 'start') {
        ...
        reqRes = [
            ...
            `รู้ไหมว่าน้องสามารถช่วยเหลือเพื่อนๆ ที่มาปรึกษาปัญหากับพี่${botName}ได้ โดยการ <a href="/donate">บริจาคประสบการณ์</a> ที่เราเคยผ่านเรื่องแย่ๆ ไปได้ พี่${botName}จะเป็นตัวกลางส่งต่อประสบการณ์ของน้องให้เพื่อนๆ ที่เจอปัญหาคล้ายๆ กัน`, 
